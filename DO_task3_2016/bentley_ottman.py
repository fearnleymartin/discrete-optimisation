# -*- coding: utf-8 -*-
"""
Created on Wed Jun 01 18:08:20 2016
...
class SweepLine:
    ...
    def get_intersection_segments(self):
        return list(self.intersection_segments)
    ...
    def _check_intersection(self, a, b):
        ...
        test = set( [a.segment[0], a.segment[1], b.segment[0], b.segment[1]])
        if len(test)==4:
            self.intersection_segments.append(((
...
#    return sweep_line.get_intersections()
    return sweep_line.get_intersection_segments()
